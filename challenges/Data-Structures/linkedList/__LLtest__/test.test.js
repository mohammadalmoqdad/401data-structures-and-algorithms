...
describe("linked List model test code challenge 3", () => {
    ...
    it("The value of k shouldn't be greater that the linked list length", () => {
        let LL = new LinkeList();
        LL.append(2).append(3).append(4);
        expect(LL.kthFromEnd(5)).toEqual('enter allowed value')
    })
    ...
    it("Where k is not a positive integer", () => {
        let LL = new LinkeList();
        LL.append(2).append(3).append(4)
        expect(LL.kthFromEnd(-2)).toEqual('enter allowed value')
    })
